  ...
  return (
    <Layout>
      ...
      <p>
        ...
        sci-fi, technical literature etc. My favorite lore is <a href="https://scp-wiki.wikidot.com/">SCP foundation</a>.
      </p>
      <h1>
        Start exploring
      </h1>
      <p>
        ...
        <ul>
          <li><a href="/notes/Goals">Goals</a></li>
          <li><a href="/notes/Digital-Garden">What is it digital garden?</a></li>
        </ul>
      </p>
    </Layout>
  );
